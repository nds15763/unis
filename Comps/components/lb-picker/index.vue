<template>
	<view v-if="visible || inline" :class="['lb-picker', inline ? 'lb-picker-inline' : '']">
		<view v-if="!inline" :class="['lb-picker-mask', animation ? 'lb-picker-mask-animation' : '']" :style="{
        ...
        zIndex: zIndex
			...
			<view v-if="showHeader" class="lb-picker-header">
				<view class="lb-picker-action lb-picker-left">
					<view class="lb-picker-action-cancel" @tap.stop="handleCancel">
				...
				<view class="lb-picker-action lb-picker-right">
					<view class="lb-picker-action-confirm" @tap.stop="handleConfirm">
			...
			<view class="lb-picker-content" :style="{ height: pickerContentHeight }">
				...
				<!-- 单选 -->
				<selector-picker v-if="mode === 'selector' && !loading && !isEmpty" :value="value" :list="list" :mode="mode" :props="pickerProps"
				 :height="pickerContentHeight" :inline="inline" :is-confirm-change="isConfirmChange" @change="handleChange">
				</selector-picker>

				<!-- 多列联动 -->
				<multi-selector-picker v-if="mode === 'multiSelector' && !loading && !isEmpty" :value="value" :list="list" :mode="mode"
				 :level="level" :visible="visible" :props="pickerProps" :height="pickerContentHeight" :inline="inline"
				 :is-confirm-change="isConfirmChange" @change="handleChange">
				</multi-selector-picker>

				<!-- 非联动选择 -->
				<unlinked-selector-picker v-if="mode === 'unlinkedSelector' && !loading && !isEmpty" :value="value" :list="list"
				 :mode="mode" :visible="visible" :props="pickerProps" :height="pickerContentHeight" :inline="inline"
				 :is-confirm-change="isConfirmChange" @change="handleChange">
